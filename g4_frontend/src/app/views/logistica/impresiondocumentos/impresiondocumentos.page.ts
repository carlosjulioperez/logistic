...
@Component({
  selector: 'app-impresiondocumentos',
  templateUrl: './impresiondocumentos.page.html',
  styleUrls: ['./impresiondocumentos.page.scss'],
})
export class ImpresiondocumentosPage implements OnInit {
  ...
  columnDefs: ColDef[] = [   
    ...
    { headerName: 'Sellos entrada', field: 'selloentrada' , resizable: true, width: 220  , minWidth: 220 ,  floatingFilter: true , cellStyle: {fontSize: '10px' , 'text-overflow':'ellipsis','white-space':'nowrap', 'overflow': 'hidden', 'padding': 0 } , editable: true,
    ...
    /*{ headerName: 'Sellos salida', field: 'sellosalida' ,  width: 140  , resizable: true ,  floatingFilter: true ,minWidth: 140 , cellStyle: {fontSize: '11px'}  , //pinned: 'left' ,
      editable: true ,
    },*/

    { headerName: 'Sellos salida', field: 'sellosalida' , resizable: true, width: 220, minWidth: 220 ,  floatingFilter: true , cellStyle: {fontSize: '10px' ,'text-overflow':'ellipsis','white-space':'nowrap', 'overflow': 'hidden', 'padding': 0 } , editable: true,
      cellEditor: 'agLargeTextCellEditor',
      cellEditorPopup: true,
      cellEditorParams: {
        maxLength: '300',
    ...
    /*
    { headerName: 'Ruta', field: 'ruta' ,  width: 180  , resizable: true ,  floatingFilter: true ,minWidth: 180 , cellStyle: {fontSize: '11px', 'text-overflow':'ellipsis','white-space':'nowrap', 'overflow': 'hidden', 'padding': 0}  , //pinned: 'left' ,
      editable: true ,
    },*/
    { headerName: 'Motivo Traslado', field: 'motivotraslado' ,  width: 150  , resizable: true ,  floatingFilter: true ,minWidth: 150 , cellStyle: {fontSize: '11px'}  , //pinned: 'left' ,
      editable: true ,
    },
    { headerName: 'Orden Compra', field: 'ordencompra' ,  width: 140  , resizable: true ,  floatingFilter: true ,minWidth: 140 , cellStyle: {fontSize: '11px' ,'text-overflow':'ellipsis','white-space':'nowrap', 'overflow': 'hidden', 'padding': 0 }  , //pinned: 'left' ,
      editable: true ,
      cellEditor: 'agLargeTextCellEditor',
      cellEditorPopup: true,
      cellEditorParams: {
    ...
    { headerName: 'Camaronera', field: 'proveedor' ,  width: 250  , resizable: true ,  floatingFilter: true ,minWidth: 270 , cellStyle: {fontSize: '11px'}  , //pinned: 'left' ,
      editable: false ,
    },
    /*
    { headerName: 'Sector', field: 'sector' ,  width: 140  , resizable: true ,  floatingFilter: true ,minWidth: 140 , cellStyle: {fontSize: '11px'}  , //pinned: 'left' ,
      editable: false ,
    },*/
    ...
    { headerName: 'Movil', field: 'transporte' ,  width: 100  , resizable: true ,  floatingFilter: true ,minWidth: 100 , cellStyle: {fontSize: '11px'}  , //pinned: 'left' ,
      editable: false ,
    },     

    { headerName: 'No.Autorizacion', field: 'autorizacion' ,  width: 120  , resizable: true ,  floatingFilter: true ,minWidth: 140 , cellStyle: {fontSize: '11px'}  , //pinned: 'left' ,
      editable: false , hide: true
    },

    { headerName: 'fechaautorizacion', field: 'fechaautorizacion' ,   width: 100  ,  cellStyle: {fontSize: '11px'} , hide: true },

    /*{ headerName: 'Sellos entrada', field: 'selloentrada' ,  width: 140  , resizable: true ,  floatingFilter: true ,minWidth: 140 , cellStyle: {fontSize: '11px'}  , //pinned: 'left' ,
      editable: true ,
    },*/
    ...
    try {
      ...
      await this.mostrarFormularioBusqueda('Lista Fechas Despachos', this.listafechadespacho , ["fechadespacho"]).then(async data => {
        if(!!data){
          ...
          await this.serviceLogisticadespacho.getImpresionDocumentosbyIdAguajeAndFechaDespacho(this.objeto.idaguaje , (<any>data).fechadespacho.slice(0,10)).then((respuesta:any) => {
            console.log('list datos' , respuesta)
            //this.listDetallePrograma = respuesta;   
            this.rowData = respuesta;  
          }) 
  ...
  async onUpdateData(){
    try {
        ...
        if(this.fechadespachofiltro!=null){
          await this.serviceLogisticadespacho.getImpresionDocumentosbyIdAguajeAndFechaDespacho(this.objeto.idaguaje , this.fechadespachofiltro).then((respuesta:any) => {
            console.log('list datos' , respuesta)
            //this.listDetallePrograma = respuesta;   
            this.rowData = respuesta;  
            this.closeLoading();
  ...
  onCellValueChanged(event:any) {
    ...
    if( event.column.colId =="selloentrada" ){
      let objeto = {id :0 , campo: '' , valor : ''};
      objeto.id =   event.data.idlogisticadespacho;  
    ...
    if( event.column.colId =="sellosalida" ){
      let objeto = {id :0 , campo: '' , valor : ''};
      objeto.id =   event.data.idlogisticadespacho;  
      objeto.campo = event.column.colId;  
      objeto.valor = event.newValue;
    ...
    if( event.column.colId =="motivotraslado" ){
      let objeto = {id :0 , campo: '' , valor : ''};
      objeto.id =   event.data.idlogisticadespacho;  
      objeto.campo = event.column.colId;  
      objeto.valor = event.newValue;
    ...
    if( event.column.colId =="ordencompra" ){
      let objeto = {id :0 , campo: '' , valor : ''};
      objeto.id =   event.data.idlogisticadespacho;  
      objeto.campo = event.column.colId;  
      objeto.valor = event.newValue;
  ...
  async descargar(tipo:any, data:any)
  {
    ...
    try {
      await this.presentLoading();
      await this.serviceLogisticadespacho.getFile(data.autorizacion, tipo , data.idsociedad ).then((data:any) => {
  ...
  async generardocumentoV1(item:any){
    ...
    this.guia.motivoTraslado = 'Compra de Camaron';
    ...
    this.guia.idusuario = this.serviceLogisticadespacho.userService.usuario.id;  
    ...
    await this.serviceLogisticadespacho.postGeneraLogisticaDespachoGuia(this.guia).then(async (resp:any) => {
      ...
      await this.serviceLogisticadespacho.postGeneraLogisticaDespachoGuiaDocumento(this.guia).then(async (respuesta:any) => {
          ...
          if(respuesta.codigo == "01"){
            ...
            await this.serviceLogisticadespacho.postUpdateAutorizacionLogisticaDespachoGuia(this.guia).then(async (data:any) => {
  ...
  async generardocumentoV2(item:any){
    ...
    if(item.motivotraslado == null || item.motivotraslado.length <= 0){
      this.showMessage('Nose ha asignado un motivo de traslado ...', "middle", "danger")
      return;
    }

    if(item.ruta == null || item.ruta.length <= 0){
      this.showMessage('Nose ha asignado una ruta ...', "middle", "danger")
      return;
    }
    ...
    try {
      ...
      this.guia.motivoTraslado = item.motivotraslado; //'Compra de Camaron';//aki
      this.guia.muelle = item.campamento;
      ...
      this.guia.ruta = item.ruta;
      this.guia.rutalogo = sociedad.logo;
      this.guia.sellos = item.sellos;
      this.guia.ordencompra = item.ordencompra;
  ...
  async generardocumento(data:any){
    ...
    if(item.motivotraslado == null || item.motivotraslado.length <= 0){
      this.showMessage('No se ha asignado un motivo de traslado ...', "middle", "danger")
      return;
    }

    if(item.ruta == null || item.ruta.length <= 0){
      this.showMessage('No se ha asignado una ruta ...', "middle", "danger")
      return;
    }
    ...
    try {
      ...
      this.guia.rutalogo = sociedad.logo;
      this.guia.sellos = item.sellos;
      this.guia.ordencompra = item.ordencompra == null ? "NA": item.ordencompra;
  ...
  async generarPdf(data:any){
    ...
    try {
      ...
      this.guia.id                    = item.idlogisticadespachoguia;
      ...
      let respuestacodigo = "";
      let respuestamensaje = "";
      await this.serviceLogisticadespacho.postGeneraLogisticaDespachoGuiaDocumentoPdf(this.guia).then(async (respuesta:any) => {
          console.log('objeto respuesta ',respuesta);
          console.log('respuesta.codigo ',respuesta.codigo);
          //this.guia.autorizacion = respuesta.autorizacion;
          //this.guia.fechaautorizacion = respuesta.fechaautorizacion;
  ...
  async mostarPDF(data:any){//numeroguia
    ...
    let datax = await this.serviceLogisticadespacho.getFile(data.autorizacion, 1 , data.idsociedad ); //data.id
  ...
  async anulardocumento(item:any){
    ...
    this.presentAlertConfirm('Atencion', 'Esta seguro que desea anular la Guia' +' '+ item.numeroguia +' '+ '?').then(async resp => {
      if(resp){
        ...
        await this.serviceLogisticadespacho.postUpdateAnularLogisticaDespachoGuia(item).then(async (resp:any) => {
        ...
        let respuestacodigo = "";
        let respuestamensaje = "";
        await this.serviceLogisticadespacho.getUpdateAnularLogisticaDespachoGuiaDocumento(item.direccionenviadas , item.direccionanuladas).then(async (respuesta:any) => {
            console.log('objeto respuesta ',respuesta);
            console.log('respuesta.codigo ',respuesta.codigo);
            respuestacodigo = respuesta.codigo;
            respuestamensaje = respuesta.mensaje1;
